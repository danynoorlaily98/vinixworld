...
if ($err=='400')echo "This bug in the query\n";
elseif ($err=='401')echo "No rights for the issuance of the documents\n";
elseif ($err=='402')echo "Not implement the code request\n";
elseif ($err=='403')echo "FORBIDDEN!!!\n";
elseif ($err=='404')echo "There is no such page\n";
