<?php /* Smarty version 2.6.26, created on 2010-11-18 17:36:45
         compiled from links.select.tpl */ ?>
<div class="select">
<?php if ($this->_tpl_vars['menu_title']): ?>
<?php echo $this->_tpl_vars['menu_title']; ?>
:&nbsp;
<?php endif; ?>
...
?>
&nbsp;
<?php if ($this->_tpl_vars['menu'][$this->_sections['any_menu']['index']][2]): ?>
<span><?php echo $this->_tpl_vars['menu'][$this->_sections['any_menu']['index']][1]; ?>
</span>
<?php else: ?>
