<?php /* Smarty version 2.6.26, created on 2010-11-18 17:36:45
         compiled from links.actions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'passgen', 'links.actions.tpl', 1, false),)), $this); ?>
<?php $this->assign('uniq', ((is_array($_tmp=8)) ? $this->_run_mod_handler('passgen', true, $_tmp) : passgen($_tmp))); ?>
<script><?php echo '
function action_links_show_'; ?>
<?php echo $this->_tpl_vars['uniq']; ?>
<?php echo '(){
document.getElementById(\'action_links_'; ?>
<?php echo $this->_tpl_vars['uniq']; ?>
<?php echo '\').style.display="block";
document.getElementById(\'action_title_'; ?>
<?php echo $this->_tpl_vars['uniq']; ?>
<?php echo '\').style.display="none";
}
'; ?>
</script>
<div id="action_title_<?php echo $this->_tpl_vars['uniq']; ?>
" class='action_title'>
<a href='javascript:action_links_show_<?php echo $this->_tpl_vars['uniq']; ?>
();'>
<b><?php echo $this->_tpl_vars['menu_title']; ?>
</b>
</a>
</div>

<div id="action_links_<?php echo $this->_tpl_vars['uniq']; ?>
" class='action_links' style='display:none;'>
