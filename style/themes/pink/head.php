...
echo "<span class=\"mfss\"><a class=\"inv marquee_tab_select\" href=\"/index.php?SESS=$sess\" accesskey=\"0\"><span>Home</span></a></span>";
}
else
{
...
echo "<span class=\"mfss\"><a class=\"inv marquee_tab_select\" href=\"/mail.php?SESS=$sess&amp;rid=$rid\" accesskey=\"3\">";
...
$knm=mysql_result(mysql_query("SELECT COUNT(*) FROM `mail` WHERE `id_kont` = '$user[id]' AND `read` = '0'"), 0);
echo "<span class=\"mfss\"><a class=\"inv\" href=\"/mail.php?SESS=$sess&amp;rid=$rid\" accesskey=\"3\">";
echo "<span>Mensajes</span>";
if ($knm>0){
echo "$knm </a></span>";
}else{
