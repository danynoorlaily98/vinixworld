<?php /* Smarty version 2.6.26, created on 2010-11-15 19:00:30
         compiled from input.form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'passgen', 'input.form.tpl', 8, false),array('modifier', 'size_file', 'input.form.tpl', 13, false),array('modifier', 'input_value_text', 'input.form.tpl', 17, false),array('function', 'html_radios', 'input.form.tpl', 19, false),)), $this); ?>
<div class='forms'>
...
<img src="/captcha.php?<?php echo ((is_array($_tmp=32)) ? $this->_run_mod_handler('passgen', true, $_tmp) : passgen($_tmp)); ?>
&amp;<?php echo @SID; ?>
" alt="" /><br />
...
<textarea<?php if ($this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['name']): ?> name="<?php echo $this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['name']; ?>
...
<input type="checkbox"<?php if ($this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['name']): ?> name="<?php echo $this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['name']; ?>
...
<input type="submit" class="button"<?php if ($this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['name']): ?> name="<?php echo $this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['name']; ?>
"<?php endif; ?><?php if ($this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['value']): ?> value="<?php echo $this->_tpl_vars['el'][$this->_sections['sect']['index']]['info']['value']; ?>
"<?php endif; ?> />
...
<?php if ($this->_tpl_vars['cancel']): ?><a href="<?php echo $this->_tpl_vars['cancel']; ?>
">Batalkan</a><?php endif; ?>
</div>