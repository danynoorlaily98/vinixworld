...
$set['title']='Библиотека - '.$file_id['name']; // заголовок страницы
$_SESSION['page']=1;
...
echo "&raquo;<a href='/lib$dir_id[dir]$file_id[name].jar'>Скачать Java</a> (<a href='/lib$dir_id[dir]$file_id[name].jad'>jad</a>)<br />\n";
echo "&raquo;<a href='/lib$dir_id[dir]$file_id[name].txt'>Скачать $file_id[name].txt</a><br />\n";
echo "&laquo;<a href='/lib$dir_id[dir]'>В папку</a><br />\n";
echo "</div>\n";
