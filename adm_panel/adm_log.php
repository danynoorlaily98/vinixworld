...
echo "<span class='ank_n'>All Activity:</span> <span class='ank_d'>$adm_log_c_all</span><br />\n";
echo "<span class='ank_n'>Activities for the month:</span> <span class='ank_d'>$adm_log_c_mes</span><br />\n";
}
else
{
...
echo "<span class='ank_n'>All Activity:</span> <span class='ank_d'>$adm_log_c_all</span><br />\n";
echo "<span class='ank_n'>Activity for the month:</span> <span class='ank_d'>$adm_log_c_mes</span><br />\n";
}
...
echo "&laquo;<a href='?id_mod=$mod[id]".($ank?"&amp;id=$ank[id]":null)."'>Action List</a><br />\n";
echo "&laquo;<a href='?$passgen".($ank?"&amp;id=$ank[id]":null)."'>List Modules</a><br />\n";
...
echo "<div class='menu'>\n";
if (mysql_num_rows($q)==0)echo "No action modules";
...
echo "<div class='foot'>\n";
if (user_access('adm_show_adm'))echo "&nbsp;<a href='administration.php'>Admin List</a><br />\n";
