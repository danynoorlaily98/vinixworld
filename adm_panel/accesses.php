...
$set['title']=output_text('Users "'.$group['name'].'" - privileges'); // заголовок страницы
...
msg('Privileges successfully changed');
}
aut();
...
echo "<input value='Apply' name='accesses' type='submit' />\n";
echo "</form>\n";



echo "<div class='foot'>\n";
echo "&nbsp;<a href='accesses.php'>Cancel</a><br/>";
echo "&nbsp;<a href='index.php'>Admin Panel</a><br/>";
echo "</div>\n";
include_once '../sys/inc/tfoot.php';
}

$set['title']='Users Privileges'; // заголовок страницы
include_once '../sys/inc/thead.php';
title();
...
echo "<div class='foot'>\n";
echo "&laquo;<a href='index.php'>Admin Panel</a><br />";
echo "</div>\n";}
include_once '../sys/inc/tfoot.php';
?>
