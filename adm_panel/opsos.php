...
{
if (!ereg("^([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})$",$_POST['min']))$err='Неверный формат IP';
if (!ereg("^([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})$",$_POST['max']))$err='Неверный формат IP';
if ($_POST['opsos']==NULL)$err='Введите название оператора';


$min=ip2long($_POST['min']);
$max=ip2long($_POST['max']);
$opsos=my_esc($_POST['opsos']);
