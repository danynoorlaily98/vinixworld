...
if($anu==0){
echo " &#183; <a href='status/like.php?id=".$statuse['id']."&amp;like'>Me gusta</a>";} else {
echo " &#183; <a href='status/like_all.php?id=".$statuse['id']."'><img src='status/suka.gif' width='12' height='13'> $anu</a> &#183; <a href='status/like.php?id=".$statuse['id']."&amp;like'>Me gusta</a>";
}
}
else
{
if($anu==0){
echo " &#183; <a href='status/like.php?id=".$statuse['id']."&amp;tidak'>Ya no me gusta</a>";} else {
echo " &#183; <a href='/status/like_all.php?id=".$statuse['id']."'><img src='status/suka.gif' width='12' height='13'> $anu</a> &#183; <a href='/status/like.php?id=".$statuse['id']."&amp;tidak'>Ya no me gusta</a>";
}
}
