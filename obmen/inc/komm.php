...
if (strlen2($msg)>1024){$err[]='Mensaje muy Largo';}
elseif (strlen2($msg)<2){$err[]='Mensaje muy Corto';}
...
msg('Tu Mensaje ha sido Publicado');
}
}
...
echo "<a href='?komm&amp;page=$page&amp;del_post=$post[id]'>Eliminar</a><br />\n";
...
echo "<input value=\"Comentar\" type=\"submit\" />\n";
echo "</form>\n";
